...
export default function Dashboard() {
  ...
  <button onClick={()=>setedit(!edit)} className="mt-4 bg-white text-blue-900 px-4 py-2 rounded hover:bg-blue-100">Edit Profile</button>
  <button  className="mt-2 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">Logout</button>
</div>
  ...
  {
    edit&&
   currentuser && <Edit_User user={currentuser} />
